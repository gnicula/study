    ...
    private static class CPU {
        ...
        private int getRegister(int opcodeRegister) {
            switch (opcodeRegister) {
                ...
                case 3 : 
                    return r3;
                default :
                    System.err.println("Trying to read a value from an invalid register ID: <" + opcodeRegister + ">");
                    return -1;
            }
        }
        ...
        private void setRegister(int opcodeRegister, byte toWrite) {
            switch (opcodeRegister) {
                ...
                case 3 : 
                    ...
                    break;
                default :
                    System.err.println("Trying to set a value to an invalid register ID: <" + opcodeRegister + ">");
            }
        }
        ...
        public void execute(byte[] program) {
            while (cycle < maxCycles) {
                ...
                // Decode opcode
                int instr = (opcode & 0xC0) >> 6; // Extract instruction code from the two most significant bits
        ...
        public String toString() {
            return String.format("Cycle:%d State:PC:%02X Z:%d R0: %02X R1: %02X R2: %02X R3: %02X", cycle, pc, z, r0, r1, r2, r3);
        }
    }

    public static void main(String[] args) {
        if (args.length < 1 || args.length > 3) {
            System.err.println("Usage: java Fiscsim <file> [<arg1> <arg2>]");
            System.exit(1);
        }
        maxCycles = 20;
